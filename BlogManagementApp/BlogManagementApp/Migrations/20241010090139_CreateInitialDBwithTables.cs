...
{
    /// <inheritdoc />
    public partial class CreateInitialDBwithTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pranaya.Rout@example.com", "Pranaya Rout" },
                    { 2, "Rakesh.Kumar@example.com", "Rakesh Kumar" },
                    { 3, "Hina.Sharma@example.com", "Hina Sharma" }
                });
